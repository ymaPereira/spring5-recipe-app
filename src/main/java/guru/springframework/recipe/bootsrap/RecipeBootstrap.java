package guru.springframework.recipe.bootsrap;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		System.out.println("Saving recipies...");
		System.out.println(event.getTimestamp()+":"+event.getApplicationContext().getApplicationName());
